...
- User Story 1 — Login: Allows user to log in and access their own tasks.  
- User Story 2 — Task Creation: Users can create tasks once logged in.  
...
**Associated User Stories:**  
- User Story 3 — Task Editing: Modify task details.  
- User Story 4 — Task Deletion: Remove tasks with undo option.  
- User Story 5 — Priority Setting: Assign/change task priority.  
- User Story 6 — Deadline Management: Set deadlines with reminders.  
...
**Associated User Stories:**  
- User Story 7 — Sorting & Viewing: Sort/filter tasks effectively.  
- User Story 8 — Search Tasks: Find tasks by keyword.  
...
**Associated User Stories:**  
- User Story 9 — Notifications: Trigger reminders at correct time.  
- User Story 10 — Task Categories/Tags: Organize tasks with categories.  
...
**Associated User Stories:**  
- User Story 13 — Intelligent Suggestions: Suggest deadlines/priorities via AI.  
...
**Associated User Stories:**  
- User Story 11 — Reliability & Security: Persist tasks securely.  
- User Story 12 — Performance: App responds instantly.  
- User Story 14 — Multi-Device Access (Future): Sync tasks across devices.  
