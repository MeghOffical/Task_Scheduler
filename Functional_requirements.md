...
**Description:**  
All user data is stored locally (SQLite or equivalent) and survives app restart.  

**Acceptance:**  
No data loss across restarts or OS sleep/wake; migration path for DB schema changes.  
