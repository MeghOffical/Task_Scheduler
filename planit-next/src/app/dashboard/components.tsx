...
export function StatCard({ icon, label, value, color }: StatCardProps) {
  ...
  return (
    <div className="relative bg-[#E8F4F8] dark:bg-gray-800/50 backdrop-blur-xl rounded-2xl shadow-lg dark:shadow-md p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
...
export function TaskCard({ task, onComplete, onDelete }: TaskCardProps) {
  ...
  return (
    <div className="group p-4 bg-[#E8F4F8] dark:bg-gray-800/50 backdrop-blur-xl rounded-xl shadow-md hover:shadow-xl dark:shadow-lg transition-all duration-300 hover:-translate-y-1">
...
export function PriorityItem({ label, count, color }: PriorityItemProps) {
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative flex justify-between items-center p-4 bg-[#E8F4F8] dark:bg-gray-800/50 backdrop-blur-xl rounded-xl shadow-md transition-all duration-300 group-hover:shadow-lg group-hover:-translate-y-1">
