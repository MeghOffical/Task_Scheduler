...
export function TaskCard({ task, onComplete, onDelete }: TaskCardProps) {
  ...
  return (
    <div className="group relative backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 rounded-xl p-4 transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] border border-white/20 dark:border-slate-700/50 shadow-lg hover:shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className={`flex-shrink-0 p-2 rounded-lg transition-all duration-300 ${
                isUpdating 
                  ...
                  : 'bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-900/40 dark:to-emerald-900/40 hover:from-green-200 hover:to-emerald-200 dark:hover:from-green-800/50 dark:hover:to-emerald-800/50 hover:shadow-lg hover:scale-110'
              }`}
          ...
          {onDelete && (
            <button
              ...
              className="flex-shrink-0 p-2 rounded-lg transition-all duration-300 bg-gradient-to-br from-red-100 to-rose-100 dark:from-red-900/40 dark:to-rose-900/40 hover:from-red-200 hover:to-rose-200 dark:hover:from-red-800/50 dark:hover:to-rose-800/50 hover:shadow-lg hover:scale-110 text-red-600 dark:text-red-400"
              title="Delete task"
            >
...
export function PriorityItem({ label, count, color }: PriorityItemProps) {
  ...
  return (
    <div className="relative group">
      <div className={`absolute inset-0 rounded-xl bg-gradient-to-br ${colors.bg} opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
      <div className="relative flex justify-between items-center p-4 backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 rounded-xl transition-all duration-300 group-hover:-translate-y-1 group-hover:scale-105 border border-white/20 dark:border-slate-700/50 shadow-lg hover:shadow-xl">
        <div className="flex items-center space-x-3">
          <div className={`p-2 rounded-lg ${colors.iconBg} shadow-md group-hover:scale-110 transition-transform duration-300`}>
            {color === 'red' && (
          ...
          <span className="font-medium text-gray-900 dark:text-gray-300 group-hover:font-semibold transition-all">{label}</span>
        </div>
        <span className={`text-xl font-bold bg-gradient-to-r ${colors.gradient} bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300 inline-block`}>
          {count}
        </span>
      </div>
    </div>
