        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex justify-between items-center">
            <div className="space-y-2">
              ...
              <p className="text-base text-gray-600 dark:text-gray-400 font-medium">Welcome back! Here&apos;s your task overview.</p>
            </div>
            <div className="hidden sm:block">
              <div className="px-4 py-2 rounded-xl backdrop-blur-xl bg-white/50 dark:bg-slate-900/50 border border-white/20 dark:border-slate-700/50 shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 relative group">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl" />
              <div className="relative backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 rounded-2xl p-6 border border-white/20 dark:border-slate-700/50 shadow-xl overflow-hidden">
                {/* Shine effect */}
                ...
                <div className="relative flex justify-between items-center mb-6">
                  ...
                  <div className="px-3 py-1.5 rounded-lg backdrop-blur-sm bg-blue-50/50 dark:bg-blue-900/20 border border-blue-200/50 dark:border-blue-700/50">
            ...
            <div>
              <div className="sticky top-6 space-y-6">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-rose-500/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl" />
                  <div className="relative backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 rounded-2xl p-6 border border-white/20 dark:border-slate-700/50 shadow-xl overflow-hidden">
                    {/* Shine effect */}
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                    
                    <h2 className="text-2xl font-bold mb-6 bg-gradient-to-r from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent relative z-10">
